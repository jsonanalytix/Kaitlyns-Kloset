  ...
  if (success) {
    return (
      <div className="flex min-h-full flex-col items-center justify-center bg-background px-4 py-12">
        <div className="w-full max-w-sm rounded-2xl bg-surface p-8 text-center shadow-sm ring-1 ring-warm-200/60">
          ...
          <p className="mt-2 text-sm leading-relaxed text-warm-500">
            ...
            <span className="font-medium text-warm-700">{email}</span>. Click it
            to activate your account.
          </p>
          <Link
            href="/login"
            className="mt-6 inline-block rounded-xl bg-blush-500 px-6 py-2.5 text-sm font-semibold text-white shadow-sm transition-all hover:bg-blush-600 active:scale-[0.98]"
          >
            Back to sign in
          </Link>
        </div>
    ...
    <div className="flex min-h-full flex-col items-center justify-center bg-background px-4 py-12">
      ...
      <div className="mb-8 text-center">
        ...
        <h1 className="text-2xl font-bold tracking-tight text-warm-900">
          Join Kaitlyn&rsquo;s Kloset
        </h1>
        <p className="mt-1 text-sm text-warm-400">
          Build your smart wardrobe today
        </p>
      </div>
        ...
        <form onSubmit={handleSignup} className="mt-6 space-y-4">
          <div>
            ...
            <div className="relative mt-1.5">
              <User className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-warm-400" />
              <input
                id="name"
                type="text"
                value={name}
