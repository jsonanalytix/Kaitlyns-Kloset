  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center px-4 py-20 text-center">
      <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-blush-50">
        <Sparkles className="h-8 w-8 text-blush-400" />
      </div>
      <h1 className="mt-5 text-xl font-bold text-warm-900">AI Stylist</h1>
      <p className="mt-2 max-w-xs text-sm leading-relaxed text-warm-500">
        Chat with your personal AI stylist to plan outfits for any occasion,
        mood, or event.
      </p>
